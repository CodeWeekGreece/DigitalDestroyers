...
function Reserve() {
    ...
    return (
        ...
        <h1 className="mb-5 mt-5">Make a reservation</h1>
        <div className="container" style={{ backgroundColor: 'rgba(222, 245, 255)', borderRadius: '25px', width: '50%'}}> 
            <div className="container">
            <div className="mb-3 row pt-5">
                
                <label htmlFor="inputPassword" className="col-sm-2 col-form-label fs-5">First Name</label>
                <div className="col-md-10">
                    <input className="form-control" id="first" name="first-name" type="text"></input>
                </div>
            </div>
            <div className="mb-3 row">
                <label htmlFor="inputPassword" className="col-sm-2 col-form-label fs-5">Last Name</label>
